        ...
        <section >
            <div class="bcontent">
                <div class="container">  <br>
                    <button type="button" onclick="window.location.href='list'" class="btn-print" style="width: 150px;color:white" target="_blank">Print All info</button><br><br>
                    <div class="bcontent">
                        <table id="example" class="display" style="width:100%">
                            ...
                            <tbody>
                            <?php $total=0; $i=1; $rows = selectAll('my_times');  foreach($rows as $row):?>
